...
select a.customer_id, customer_name, avg(a.balance_amount) from bank_account_details a join bank_customer b on a.customer_id=b.customer_id group by customer_id; 
...
select a.customer_id,a.account_number, if(a.account_type='Credit Card',if(a.balance_amount=0,b.transaction_amount,a.balance_amount),a.balance_amount) Balance from bank_account_details a join bank_account_transaction b;
...
select b.transaction_Date,a.account_number,a.balance_amount,b.transaction_amount from bank_account_details a join bank_account_transaction b on a.account_number=b.account_number where b.transaction_Date like '2020-03-__' or b.transaction_date like '2020-04-__' order by b.transaction_Date;
...
select a.customer_id, a.account_number, a.balance_amount, b.transaction_amount, b.transaction_date from bank_account_details a join bank_account_transaction b order by a.customer_id;
...
select a.customer_id,a.account_number,a.balance_amount,b.transaction_amount,b.transaction_date from bank_account_details a join bank_account_transaction b on a.account_number=b.account_number;
...
select a.account_number,a.account_type,b.event,b.customer_message from bank_account_details a join bank_customer_messages b where a.account_type='SAVINGS' group by account_number;
...
select customer_id,a.account_number,account_type,balance_amount previous_balance,transaction_amount,if(transaction_amount<0,balance_amount+transaction_amount,balance_amount) deducted_balance from bank_account_details a join bank_account_transaction where relationship_type='P';
...
select a.account_number, a.account_type, a.balance_amount, b.linking_account_number from bank_account_details a join bank_account_relationship_details b on a.account_number=b.account_number;
...
select a.account_number, a.account_type, a.balance_amount, b.linking_account_number,c.transaction_amount from bank_account_details a join bank_account_relationship_details b on a.account_number=b.account_number join bank_account_transaction c;

# Question 10:
# 10) Display all account holders from Bank_Accounts_Details table who have “Add-on Credit Cards" and “Credit cards" 
select a.customer_id,a.customer_name,b.account_type from bank_customer a join bank_account_details b on a.customer_id=b.customer_id where account_type like '%credit%'; 
...
select a.customer_id from bank_Account_Details a join bank_account_relationship_details b where a.account_type='SAVINGS' group by a.customer_id having b.account_type like 'Credit card';
