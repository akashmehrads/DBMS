...
alter table Bank_Inventory modify Product varchar(6);  #error product already contains a record with size more than 6
...
update Bank_Holidays set Holiday = '2021-06-03';
select * from Bank_Holidays;
