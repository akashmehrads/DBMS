...
insert into bank_inventory values('DailCard',2,380,8500.87,9000.00 + 9000.00/100*10,null);
select * from bank_inventory;
...
delete from bank_inventory where estimated_sale_price-purchase_cost<estimated_sale_price/100*5;
select * from bank_inventory;
...
##Query works but there is no holiday 2020-03-20 in the table

# Use tables cricket_1 and cricket_2 from Online_Day2_InClass to answer the queries. 
##imported cricket_1 and cricke_2 into DB bank using Table Data Import Wizard into database
...
select Player_Id,Player_name from cricket_1 where Popularity>=10 and Popularity<=12;
